...
import { getLoginState, getUser, isAuthenticated } from './menu/reducer';
...
class AMeDashboard extends Component {
	...
	getData() {
		api
			.get(`dashboard/info/${this.state.dashboardId}`)
			.then(response => {
			...
			<div>
				<header className="header clearfix">
					<div className="container-fluid flexbox">
						...
						<div className="intro">
							...
							{isAuthenticated && (
								<button
									className="btn btn-default intro__button"
									onClick={() => {
										this.openModal();
									}}
								>
						...
						{isAuthenticated ? (
							<HamburgerMenu
								setHamburgerMenuOpen={this.setHamburgerMenuOpen}
								openModal={() => {
									this.openModal();
								}}
							/>
				...
				<div className="container-fluid">
					<div className="">
						...
						{isAuthenticated && <Alert stack={{ limit: 3 }} />}
							...
							>
								<div className="modal-content">
									...
									<div className="modal-body">
										<AdminEditForm
											blank={this.state.isHamburgerMenuOpen}
											dashboardId={this.props.match.params.dashboardId}
										/>
									</div>
...
const AMeDashboardContainer = connect(mapStateToProps)(AMeDashboard);
