	...
	handleFormSubmit = event => {
		...
		geocodeByAddress(this.state.address)
			...
			.then(({ lat, lng }) => {
				...
				axios
					.get(
						'https://maps.googleapis.com/maps/api/geocode/json?language=en',
				...
				<form onSubmit={this.handleFormSubmit}>
					<div className="form-group">
						...
						<input
							...
							id="cityListInput"
							aria-describedby="cityListInput"
							onChange={this.handleInputChange}
							value={this.state.cityListInputValues}
							placeholder=""
						/>
					</div>
					...
					<div className="form-group">
						<label className="weather__label weather__label--smaller">
							Add another city
						</label>
						<PlacesAutocomplete
							inputProps={inputProps}
							classNames={placesCss}
						/>
						<button
							className="btn btn-default btn--green weather__margin-top_btn"
							type="submit"
						>
							Add a city
						</button>
