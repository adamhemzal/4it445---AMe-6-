...
export class WeatherWidget extends React.PureComponent {
    ...
    componentDidMount() {
        api('weather')
              .then(response => {
                  ...
                  this.getWeatherFromCities(cities/*array*/);
              })
              .catch(error => {
                  console.log(error);
              });
    ...
    getWeatherFromCities(cities) {
        axios.all([
            axios.get('http://api.openweathermap.org/data/2.5/forecast?q=' + cities[0] + '&APPID=2bea6777b99c3b978671f4ab647b0948'),
            axios.get('http://api.openweathermap.org/data/2.5/forecast?q=' + cities[1] + '&APPID=2bea6777b99c3b978671f4ab647b0948'),
            axios.get('http://api.openweathermap.org/data/2.5/forecast?q=' + cities[2] + '&APPID=2bea6777b99c3b978671f4ab647b0948'),
            axios.get('http://api.openweathermap.org/data/2.5/forecast?q=' + cities[3] + '&APPID=2bea6777b99c3b978671f4ab647b0948')
        ])
